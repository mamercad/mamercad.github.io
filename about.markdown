...
<figure class="author-photo" aria-label="Mark Mercado (black and white headshot)">
  <img
    src="{{ site.author_avatar_bw | relative_url }}"
    alt="Mark Mercado (black and white headshot)"
    width="256"
    height="256"
    loading="lazy"
    decoding="async"
